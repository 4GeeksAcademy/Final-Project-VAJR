...
export const MostSearchedSpecialists = () => {
    ...
    return (
        <div className="container-fluid p-2" style={{ backgroundColor: "#ffffff" }}>
            <h2 className="ms-5"><strong>Top-searched specialties</strong></h2>
            <div className="d-flex justify-content-center my-5">
                <button className="btn mx-3 p-4 rounded-4 fs-4 specialties-button" style={{ backgroundColor: "#93BFEF", width: "210px" }}>
